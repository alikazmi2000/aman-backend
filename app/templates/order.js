exports.invitationTemplate = (data,key) => {
  ...
  <table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%" >
    <tr>
      ...
      <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td style="border-bottom: 3px solid #04101d;" width="100%">
            <center>
                  ...
                  <tr>
                    <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" height="303">
                      ...
                      <td class="hide reveal">
                        ...
                        <td style="width:150px; height:33px; background-color: #04101d;" >
                          <div>
                            <a href="#" style="background-color:#04101d;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">My Account</a>
                            </div>
                        </td>
                        <td>
                          &nbsp;
                        ...
                        <tr>
                          <td style="text-align: left;">
                            <span class="important-font">
                              ${data.billing.first_name} <br>
                            </span>
                            ${  ' Address: ' +data.billing.address+ '<br>'}
                         
                           ${  (data.shipping & data.shipping.address)? 'Shipping Address '+data.shipping.address:''}
                          ...
                          <tr>
                            ...
                            <td class="mobile-block" width="33%">
                              <table cellspacing="0" cellpadding="0" class="force-full-width">
                                <tr>
                                  <td class="mobile-border" style="background-color: #04101d; color: #ffffff; padding: 5px; border-right: 3px solid #ffffff;">
                                    Items
                                  </td>
                                </tr>
                                ${data.line_items.map(e=>{
                                  return(
                                     `<tr>
                            ...
                            <td class="mobile-block" width="34%">
                              <table cellspacing="0" cellpadding="0" class="force-full-width">
                                <tr>
                                  <td style="background-color: #04101d; color: #ffffff; padding: 5px;">
                                    Price
                                  </td>
                                </tr>
                                ${data.line_items.map(e=>{
                    ...
                    <tr>
                      <td class="mobile-padding">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%">
                          <tr>
                            <td style="text-align: left;">
                              Subtotal :  ${data.invoice.grand_total - data.invoice.shipping_fee} $ .
                              <br>
                              <br>
                            </td>
                          </tr>
                          <tr>
                          <td style="text-align: left;">
                           Shipping  ${data.invoice.shipping_fee} $ .
                          <br>
                          <br>
                        </td>
                          <tr>
                          <tr>
                          <td style="text-align: left;">
                           Gross Total  ${data.invoice.grand_total} $ .
                          <br>
                          <br>
                        </td>
                          <tr>
                  ...
                  <td>
                    <table cellspacing="0" cellpadding="0" width="100%">
                      <tr>
                        ...
                        <br>
                          Thank you for your business. Please <a href="https://amanstyles.com">contact us</a> with any questions regarding this invoice.
                        <br>
                        <br>
                        <br>
                        <br>
        ...
        <tr>
          <td style="background-color:#c2c2c2;display:none" >
            <center>
              <table cellspacing="0" cellpadding="0" width="500" class="w320">
                <tr>
                  <td>
